...
async def process_care_plan(event: PostbackEvent | MessageEvent) -> int:
    ...
    if postback_data == "create_care_plan":
        ...
        await line_bot_api.reply_message(
            ...
            messages=[
                TextMessage(text="それでは、いくつか質問をするので回答をお願いします🙏 質問は合計で9つです"),
        ...
        user_ref.set({"answers": {"question_1": user_answer}, "state": "wait_q2"}, merge=True)
        await line_bot_api.reply_message(
            ReplyMessageRequest(
                reply_token=event.reply_token,
                messages=[
                    TextMessage(text="Q.2 医師からの介護サービスや医療的ケアの指示、健康状態について教えてください。\n"
        ...
        user_ref.set({"answers": {"question_2": user_answer}, "state": "wait_q3"}, merge=True)
        await line_bot_api.reply_message(
            ReplyMessageRequest(
                reply_token=event.reply_token,
                messages=[
                    TextMessage(text="Q.3 食事について、最近の様子を教えてください。\n\n"
        ...
        user_ref.set({"answers": {"question_3": user_answer}, "state": "wait_q4"}, merge=True)
        await line_bot_api.reply_message(
            ReplyMessageRequest(
                reply_token=event.reply_token,
                messages=[
                    TextMessage(text="Q.4 トイレや入浴について、最近の様子を教えてください。\n\n"
        ...
        user_ref.set({"answers": {"question_4": user_answer}, "state": "wait_q5"}, merge=True)
        await line_bot_api.reply_message(
            ReplyMessageRequest(
                reply_token=event.reply_token,
                messages=[
                    TextMessage(text="Q.5 ご本人の物忘れや会話、外出について気になることはありますか？\n\n"
                                "【例】\n•物忘れが増えている\n•外出や人と話す機会が減っている"),
                ],
            )
        )
        ...
        user_ref.set({"answers": {"question_5": user_answer}, "state": "wait_q6"}, merge=True)
        await line_bot_api.reply_message(
            ReplyMessageRequest(
                reply_token=event.reply_token,
                messages=[
        ...
        user_ref.set({"answers": {"question_6": user_answer}, "state": "wait_q7"}, merge=True)
        await line_bot_api.reply_message(
            ReplyMessageRequest(
                reply_token=event.reply_token,
                messages=[
        ...
        user_ref.set({"answers": {"question_7": user_answer}, "state": "wait_q8"}, merge=True)
        await line_bot_api.reply_message(
            ReplyMessageRequest(
                reply_token=event.reply_token,
                messages=[
        ...
        user_ref.set({"answers": {"question_8": user_answer}, "state": "wait_q9"}, merge=True)
        await line_bot_api.reply_message(
            ReplyMessageRequest(
                reply_token=event.reply_token,
                messages=[
        ...
        user_ref.set({"answers": {"question_9": user_answer}, "state": "wait_care_plan"}, merge=True)
